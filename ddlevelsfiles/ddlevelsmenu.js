...
init:function(mainmenuid, dir, ustyle){
    this.uniquestyle=ustyle
	...
	for (var i=0; i<alllinks.length; i++){
		if (alllinks[i].getAttribute('rel')){
			...
			shelldiv.className = ustyle//"ddsubmenustyle"
...
setup:function(mainmenuid, dir, ustyle){
    //this.domready(function () { ddlevelsmenu.init(mainmenuid, dir, ustyle) })
    $(window).load(function () { ddlevelsmenu.init(mainmenuid, dir, ustyle) })
}
